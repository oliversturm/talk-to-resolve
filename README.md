...
![Demo Animation](./docs/images/ttr-hackernews.gif)
...
**Note** that this code assumes an authentication/authorization setup along the lines of [this description](https://github.com/reimagined/resolve/blob/master/docs/authentication-and-authorization.md). **It would be very dangerous to allow TTR access to a production application without a working security system!** However, you may consider different approaches for development purposes.
...
| `aggregate show commands <name>`                                                     | `agg-show <name>`                                                   | List commands implemented for the aggregate<br>Options are supported:<br>`--verbose` includes the `toString` representation of the command function in the output.                                                                                                                                                                                                                                                                                                                    |
